...
typedef struct
{
    ...
    void (*draw_horizontal_line)(int16_t x, int16_t y, int16_t length);
    void (*draw_vertical_line)(int16_t x, int16_t y, int16_t length);
    void (*draw_rect)(int16_t x, int16_t y, int16_t width, int16_t height);
    void (*draw_fill_rect)(int16_t xMove, int16_t yMove, int16_t width, int16_t height);
    ...
    void (*draw_circle)(int16_t x0, int16_t y0, int16_t radius);
    void (*draw_fill_circle)(int16_t x0, int16_t y0, int16_t radius);
